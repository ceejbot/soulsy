...
namespace offset
{
	constexpr REL::RelocationID left_hand_equip_slot(23150, 23607);
	constexpr REL::RelocationID right_hand_equip_slot(23151, 23608);
	//constexpr REL::RelocationID get_either_hand_slot(23152, 23609);
	constexpr REL::RelocationID getPowerEquipSlot(23153, 23610);
