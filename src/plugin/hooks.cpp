...
namespace hooks
{
		...
		RE::BSTEventSource<RE::InputEvent*>* eventSource)
	{
		...
		if (const auto buttonEvent = event->AsButtonEvent())
		{
			...
			void PlayerHook::pick_up_object(
				RE::Actor * actor, RE::TESObjectREFR * object, uint32_t count, bool a_arg3, bool a_play_sound)
			{
			...
			void PlayerHook::add_item_functor(
				RE::TESObjectREFR * a_this, RE::TESObjectREFR * object, int32_t count, bool a4, bool a5)
			{
